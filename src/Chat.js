...
const Chat = () => {
  ...
  function sendMessage(ev, file = null) {
    ...
    if (file) {
      ...
      setNewMsgText('');
      setMessages(prev => ([...prev,{text:newMsgText, sender: id, recipient: selectUser, _id : Date.now()}]));
    }
  }
        ...
        <div className='flex flex-col bg-blue-100 w-2/3 p-2'>
            <div className='flex-grow'>
              ...
              {!!selectUser && (
                ...
                <div className="overflow-y-scroll absolute top-0 right-0 left-0 bottom-2 custom-scrollbar">
